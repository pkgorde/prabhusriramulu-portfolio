  ...
  return (
    <section id="contact" className="section-spacing bg-white">
      <div className="container-custom max-w-4xl">
        <h2 className="text-5xl md:text-6xl font-bold text-primary mb-12">
          Want to chat?
        </h2>
        ...
        <div className="space-y-8 mb-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-xl md:text-2xl text-dark font-medium">(555) 123-4567</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <a
                ...
                className="text-xl md:text-2xl text-dark font-medium hover:text-primary transition-colors"
              >
                prabhu@example.com
              </a>
            </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm text-gray-500 uppercase tracking-wide">Schedule a Meeting</p>
              <a
          ...
          <div className="flex flex-wrap gap-4">
            {socialLinks.map((social, index) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-3 px-6 py-3 bg-gray-100 hover:bg-primary hover:text-white rounded-full transition-colors group"
              >
